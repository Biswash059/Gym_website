...
const Register = () => {
  ...
  return (
    <section
      className="min-h-[110vh] bg-center bg-cover bg-no-repeat"
      style={{
    ...
    >
      ...
      <div className="flex justify-center items-center mt-10 md:mt-16">
        ...
        >
          ...
          <button type='submit' className="relative w-full mt-5 bg-red-600 rounded text-white border border-white px-4 py-2 z-20 group overflow-hidden">
